try {
  ...
  // It is fairly experimental technology, if no support, hide the app.
  console.error(ex);
...
recognition.onspeechend = () => {
  ...
  instructions.innerHTML =
    "<span class='important'>Speech detection stopped.</span>";
};

recognition.onerror = (e) => {
  console.error(e);
  e.error == "no-speech"
    ? (instructions.innerHTML = "No speech detected.")
    : (instructions.innerHTML = "Error occured");
  document.getElementById("listenBtn").classList.remove("started");
  document.getElementById("listenBtn").innerHTML = "Listen";
};
